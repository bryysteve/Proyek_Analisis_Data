...
with st.sidebar:
    # Title
    st.title("Bryant S. Aritonang")

    # Logo Image
    st.image("dashboard/ecomm.jpg")
...
with tab2:
    ...
    with st.expander("See Explanation"):
        st.write('Analisis grafik menunjukkan bahwa terdapat lebih banyak pelanggan di bagian tenggara dan selatan, serta mayoritas pelanggan berada di kota-kota yang merupakan ibu kota, seperti São Paulo, Rio de Janeiro, Porto Alegre, dan lainnya.)')

st.caption('Copyright (c) Bryant 2024')
